Arithmetic operator of **subtraction**. This operator is used in the [arithmetic expressions](definition_of_an_expression.md) between two operands, to obtain the result of this subtraction.
